...
public class SodiumOptionsGUI extends Screen {
    ...
    private FlatButtonWidget applyButton, closeButton, undoButton, vanillaButton;
    ...
    private void rebuildGUI() {
        ...
        this.undoButton = new FlatButtonWidget(new Dim2i(this.width - 241, this.height - 30, 65, 20), new TranslatableText("sodium.options.buttons.undo"), this::undoChanges);
        this.applyButton = new FlatButtonWidget(new Dim2i(this.width - 172, this.height - 30, 65, 20), new TranslatableText("sodium.options.buttons.apply"), this::applyChanges);
        this.closeButton = new FlatButtonWidget(new Dim2i(this.width - 103, this.height - 30, 65, 20), new TranslatableText("sodium.options.buttons.close"), this::onClose);
        this.vanillaButton = new FlatButtonWidget(new Dim2i(this.width - 34, this.height - 30, 20, 20), new TranslatableText("V"), this::showVanilla);
        ...
        this.addDrawableChild(this.vanillaButton);
    ...
    public void showVanilla() {
        this.client.setScreen(new VideoOptionsScreen(this, client.options));
    }
}
